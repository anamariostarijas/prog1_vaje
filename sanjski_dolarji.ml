...
želimo najti najkrajši seznam, da bo vsota enaka n*)
...
(*
   Denimo, da moramo vrniti število n, moramo najprej najti najmanjši seznam za n-vsak od denominatorjev, kjer denominator manjši od n
*)
